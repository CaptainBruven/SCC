...
class SpeciesRelationAdmin(admin.ModelAdmin):
...
class LoreArticleEntityInline(admin.TabularInline):
    model = LoreArticleEntity
    extra = 0


@admin.register(LoreArticle)
class LoreArticleAdmin(admin.ModelAdmin):
...
class LoreArticleEntityAdmin(admin.ModelAdmin):
